...
public class GraficoBarras extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString("Producto A", 500, 190);
        g2d.drawString("Producto B", 500, 210);

        //Genera las graficas segun los datos introducidos por el usuario.
        // Trimestre 1        
        g2d.setColor(Color.blue);
        g2d.fillRect(60, 400 - ((dato1 * 400) / dato9), 30, ((dato1 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString(dato1 + "%", 63, 400 - ((dato1 * dato9) / 400) - 20);

        g2d.setColor(Color.red);
        g2d.fillRect(95, 400 - ((dato5 * 400) / dato9), 30, ((dato5 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        // Trimestre 2
        g2d.setColor(Color.blue);
        g2d.fillRect(160, 400 - ((dato2 * 400) / dato9), 30, ((dato2 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString(dato2 + "%", 163, 400 - dato2 - 20);

        g2d.setColor(Color.red);
        g2d.fillRect(195, 400 - ((dato6 * 400) / dato9), 30, ((dato6 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        // Trimestre 3
        g2d.setColor(Color.blue);
        g2d.fillRect(260, 400 - ((dato3 * 400) / dato9), 30, ((dato3 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString(dato3 + "%", 263, 400 - dato3 - 20);

        g2d.setColor(Color.red);
        g2d.fillRect(295, 400 - ((dato7 * 400) / dato9), 30, ((dato7 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        // Trimestre 4
        g2d.setColor(Color.blue);
        g2d.fillRect(360, 400 - ((dato4 * 400) / dato9), 30, ((dato4 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        g2d.drawString(dato4 + "%", 363, 400 - dato4 - 20);

        g2d.setColor(Color.red);
        g2d.fillRect(395, 400 - ((dato8 * 400) / dato9), 30, ((dato8 * 400) / dato9));
        g2d.setColor(Color.black);
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
